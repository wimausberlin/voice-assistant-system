...
class Listener:
    def __init__(self, args: Tuple[int, int, str, str, bool, bool], input_device_index: int = None) -> None:
        """
    ...
    def save_audio(self, filename: str, frames: List[str]) -> None:
        """
        filename: name of the saved new audio file.
...
def sample(args: Tuple[int, int, str, str, bool, bool]) -> None:
    ...
    try:
        ...
        while True:
            ...
            frames = []
            input(
                f'Press enter to record. Each sample will be {args.seconds} seconds.')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--samples_save_path', type=str, default=None, required=False,
                        help='directory to save all the word samples (i.e. sound/)')
    parser.add_argument('--sample', default=False, action='store_true', required=False,
                        help='sets to interactive mode')
    parser.add_argument('--input_index', default=False, action='store_true', required=False,
